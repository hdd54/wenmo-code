...
SKILL_DIRS = [
    ...
    # Superpowers 插件技能库（Claude 插件市场，14 个高质量工作流技能：brainstorming/TDD/计划等）
    os.path.expandvars(r"%USERPROFILE%\.claude\plugins\cache\claude-plugins-official\superpowers\6.1.1\skills"),
    # Autoharness 技能库（harness 生成器：workspace-discovery/install-harness/tune-harness/verify-harness）
    r"D:\Anaconda32024\Lib\site-packages\autoharness\data\.github\skills",
