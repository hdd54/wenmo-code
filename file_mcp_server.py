...
def handle_file_write(args):
    ...
    with open(fpath, "w", encoding="utf-8") as f:
        f.write(content)
    url = "http://127.0.0.1:8000/files/" + urllib.parse.quote(name)
...
def handle_file_zip(args):
    ...
    url = "http://127.0.0.1:8000/files/" + urllib.parse.quote(zip_name)
...
def handle_file_convert(args):
    ...
    try:
        ...
        url = "http://127.0.0.1:8000/api/files/preview/" + urllib.parse.quote(name)
        ...
        with urllib.request.urlopen(req, timeout=120) as resp:
            ...
            with open(pdf_path, "wb") as f:
                f.write(resp.read())
        link = "http://127.0.0.1:8000/files/" + urllib.parse.quote(pdf_name)
